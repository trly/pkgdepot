...
- Preserve decompression limits: gzip/bzip2/xz decoded output is capped at 64 MiB; xz dictionary and zstd memory/window are also capped. Zstd does not have the same total-output cap.
