...
- The server is an OAuth 2.0 protected resource: signed JWT access tokens must carry the requested `package:publish` or `package:remove` scope. The provider owns user, group, client, and permission policy.
